<div align="center">
  ...
  <p align="center">
    <a href="https://nutrivedic-backend.onrender.com/api/health"><img src="https://img.shields.io/badge/Render-Deployed-brightgreen?style=for-the-badge&logo=render" alt="Render Deployed"></a>
    <a href="https://documenter.getpostman.com/view/50840877/2sBY4WmveL"><img src="https://img.shields.io/badge/Postman-Documentation-FF6C37?style=for-the-badge&logo=postman" alt="Postman Docs"></a>
    <a href="https://github.com/Sushant-Ravi14/NutriVedic"><img src="https://img.shields.io/badge/Team-Code%20Invaders-orange?style=for-the-badge&logo=github" alt="Code Invaders"></a>
    <img src="https://img.shields.io/badge/Node.js-v20%2B-blue?style=for-the-badge&logo=node.js" alt="Node.js">
    <img src="https://img.shields.io/badge/React-Vite-61DAFB?style=for-the-badge&logo=react" alt="React Vite">
    <img src="https://img.shields.io/badge/MongoDB-Atlas-47A248?style=for-the-badge&logo=mongodb" alt="MongoDB">
    <img src="https://img.shields.io/badge/AI-Google%20Gemini-8E75B2?style=for-the-badge&logo=google" alt="Google Gemini">
  </p>
...
```mermaid
graph TD
    A[React 18 + Vite Frontend] -->|REST API + Axios| B[Node.js + Express Backend]
    B -->|Database| C[(MongoDB Atlas)]
    B -->|Caching & Sessions| D[(Redis Cloud)]
    B -->|AI Vision & Analytics| E[Google Gemini AI API]
    B -->|Nutrition DB| F[USDA & OpenFoodFacts]
    B -->|Cloud Storage| G[Cloudinary]
    B -->|Deploy| H[Render Cloud Web Service]
```
